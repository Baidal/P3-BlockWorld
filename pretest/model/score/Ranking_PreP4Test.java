...
public class Ranking_PreP4Test {
	...
	public void testAddScore2() {
		try {
			...
			addScoresGame(pJulia,"Julia",new ItemStack(Material.IRON_PICKAXE,1),BlockFactory.createBlock(Material.OBSIDIAN),new Location(world,0,67,1),false);
