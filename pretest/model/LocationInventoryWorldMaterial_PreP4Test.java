...
public class LocationInventoryWorldMaterial_PreP4Test {
	...
	public void testCompareToSameXDifferentY() {
		Location location1 = new Location(w, 7, 10, -3);
		Location location2 = new Location(w, 7, 7, -3);
	...
	public void testCompareToSameXYDifferentZ() {
		Location location1 = new Location(w, 7, 7, 3);
		Location location2 = new Location(w, 7, 7, -3);
		assertEquals(1,location1.compareTo(location2));
		location1.setZ(-4);
		assertEquals(-1,location1.compareTo(location2));
	...
	public void testConstructorCopiaInventory2() {
		...
		invent1.addItem(isApple);
		invent1.addItem(isGrass);
		invent1.addItem(isApple);
		invent1.setItemInHand(isGrass);
		Inventory invent2= new Inventory(invent1);
		assertEquals(invent1,invent2);
